...
describe('computeOuterEdge', () => {
  ...
  it('returns null when the pointer is outside the dashboard', () => {
    expect(computeOuterEdge(DASH, { x: -10, y: 100 }, 16)).toBeNull();
    expect(computeOuterEdge(DASH, { x: 100, y: -1 }, 16)).toBeNull();
