...
try {
  ...
  globalThis.dh = dhModule.default ?? dhModule;
  globalThis.postMessage(
    {
      source: '@deephaven/code-studio',
      event: '@deephaven/jsapi-shim/EventAPILoadSuccess',
    },
    window.origin
  );
} catch (e) {
  ...
  globalThis.postMessage(
    {
      source: '@deephaven/code-studio',
      event: '@deephaven/jsapi-shim/EventAPILoadFailure',
      payload: `${e}`,
    },
    window.origin
  );
